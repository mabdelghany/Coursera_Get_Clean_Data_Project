...
Once you have obtained and unzipped the source files, you will need to unqip the file in a folder named `data` in your working directory. i.e. All the files and subfolders must be in `./data/UCI HAR Dataset/`
